...
<div class="container my-4">
    ...
    <form method="GET" class="mb-3">
        <div class="input-group">
            <input type="text" name="buscar_cedula" class="form-control" placeholder="Buscar por cédula"
                value="<?= isset($_GET['buscar_cedula']) ? htmlspecialchars($_GET['buscar_cedula']) : '' ?>">
    ...
    if (!empty($_GET['buscar_cedula'])) {
        $cedula_busqueda = $_GET['buscar_cedula'];
        $clientes_filtrados = array_filter($this->clientes, function ($cliente) use ($cedula_busqueda) {
            return strpos($cliente['cedula'], $cedula_busqueda) !== false;
        });
    }
    ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal"
                        data-bs-target="#modalEditarCliente" data-id="<?= $cliente['id_cliente'] ?>"
                    ...
                    <!-- Botón eliminar -->
                    <form method="POST" action="<?php echo constant('URL');?>cliente/eliminar" style="display:inline;"
